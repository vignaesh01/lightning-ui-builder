...
var uiMenu = {
	'title' : 'ui:menu',
	'description' : 'A dropdown menu list with a trigger that controls its visibility. To create a clickable link and a list of menu items, use ui:menuTriggerLink and ui:menuList.',
	"selected" : false,
	'attributes' : [
			{
				'name' : 'aura:id',
